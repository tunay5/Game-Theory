---
title: "Game Theory"
subtitle: "Nash Equilibrium (Static and Complete Information Games)"
...
## Different Types of Games: Prisoners' Dilemma
\begin{itemize}
...
\begin{itemize}
  ...
  $$u_i(s_{1}^{\ast},s_{2}^{\ast})>u_i(s_{1i},s_{2i})\;\; \forall \;\;i \in \{1,2...n\}$$
  $$n=2$$
\end{itemize}
